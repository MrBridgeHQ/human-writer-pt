...
Priority ranking, applied on top of the language adapter (`tells-stylistic-pt.md`):
...
- `tells-stylistic-pt.md`: language-specific vocabulary and construction tells
