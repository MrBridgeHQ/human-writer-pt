...
> Doctrine for the `human-writer` skill, applied to short-form comms: emails, LinkedIn posts and DMs, Slack/Teams messages to clients, X/Twitter replies, GitHub issue comments, customer replies. Loaded in addition to language-specific stylistic tells (`tells-stylistic-pt.md`).
...
- Use one Portuguese/English borrowing if you naturally code-switch (if you do)
<!-- human-writer:ignore-end -->
...
- [ ] No tier-1 AI vocab (see `tells-stylistic-pt.md`)
...
- `tells-stylistic-pt.md`: full vocabulary and construction lists to avoid
